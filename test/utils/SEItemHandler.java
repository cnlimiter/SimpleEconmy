...
public class SEItemHandler extends ItemStackHandler {
    private final List<Slot> containerSlots;

    public SEItemHandler(int size, List<Slot> containerSlots, ItemStack... stacks) {
        super(size);
    ...
    public boolean isItemValid (int slot, @Nonnull ItemStack stack) {
        ...
        if (containerSlots != null && containerSlots.get(slot) != null && containerSlots.get(slot) instanceof SlotFilter) {
            return ((SlotFilter) containerSlots.get(slot)).mayPlace(stack);
        }
