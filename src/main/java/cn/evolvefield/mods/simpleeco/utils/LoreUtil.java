...
public class LoreUtil {
    ...
    public static void addControlsLore (List<ITextComponent> tooltip, String lore, LoreUtil.Type type) {
        addControlsLore(tooltip, lore, type, false);
    }

    public static void addControlsLore (List<ITextComponent> tooltip, String lore, LoreUtil.Type type, boolean isFirst) {
    ...
    private static void addActionLore (List<ITextComponent> tooltip, String lore, LoreUtil.Type type) {
